...
import com.kh.coupang.config.JpaConfig;
...
public class ProductCommentService {
    ...
    @Autowired
    private JPAQueryFactory queryFactory;  // JpaConfig안에 있음
